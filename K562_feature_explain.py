...
np.save('explainer/K562/one_chr_' + str(args.test_chr) + '.npy', one_node_feat_importance)
np.save('explainer/K562/zero_chr_' + str(args.test_chr) + '.npy', zero_node_feat_importance)
